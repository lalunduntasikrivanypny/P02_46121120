                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered  mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td scope="row">B-001</td>
                                            <td scope="row">B-001</th>
                                            <td scope="row">B-001</th>
                                            <td scope="row">B-001</th>
                                            <td class="text-center">
                                                <a href="<?= APLIKASI; ?>/barang/hapus" button class="btn btn-primary btn-sm"> PILIH </button> </a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <div class="modal-footer">
                                    <button> <a href="<?= APLIKASI; ?>/tawar/input" type="button" class="button btn-sm"> <b>TUTUP</b> </button> </a>
                                </div>
                            </div>
